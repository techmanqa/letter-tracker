...
-- Saved addresses and purchase sources (src/app/profile/page.tsx manages
-- these; src/app/add/page.tsx and src/app/edit/[id]/page.tsx read them to
-- prefill letters). Both tables already existed in the live project with
-- working RLS (verified by an unauthenticated REST call returning 0 rows,
-- same as `letters`) but were missing from this schema file.
